...
(function () {
	...
	// Stop autoplay when tab is hidden; restart when visible
	document.addEventListener('visibilitychange', () => {
		if (document.hidden) pauseAutoplay();
		else resumeAutoplay();
	});

	window.addEventListener('blur',  pauseAutoplay,  { passive: true });
	window.addEventListener('focus', () => resumeAutoplay(), { passive: true });
